      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 mb-8">
        <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-8 sm:p-12 border-4 border-gray-900 shadow-xl">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-gray-900 text-center mb-4">
            <span className="bg-yellow-300 px-2">STILL</span> NOT SURE ABOUT PROURLMONITOR?
          </h2>
          <p className="text-center text-gray-700 text-base sm:text-lg mb-8">
            Ask your favorite AI what they think! See what ChatGPT, Claude, Gemini, or Perplexity say about our tools.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="flex items-center gap-3 px-6 py-4 bg-[#10A37F] hover:bg-[#0D8C6F] text-white border-2 border-gray-900 rounded-2xl font-bold transition-all hover:scale-105 shadow-md"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-6 py-4 bg-[#CC9B7A] hover:bg-[#B8876B] text-white border-2 border-gray-900 rounded-2xl font-bold transition-all hover:scale-105 shadow-md"
            >
              <span className="text-2xl">🎨</span>
              Ask Claude
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-[#4285F4] to-[#8E44AD] hover:opacity-90 text-white border-2 border-gray-900 rounded-2xl font-bold transition-all hover:scale-105 shadow-md"
            >
              <span className="text-2xl">✨</span>
              Ask Gemini
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-6 py-4 bg-[#20B8B8] hover:bg-[#1A9999] text-white border-2 border-gray-900 rounded-2xl font-bold transition-all hover:scale-105 shadow-md"
            >
              <span className="text-2xl">🔍</span>
              Ask Perplexity
            </a>
