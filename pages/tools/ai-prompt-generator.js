...
export default function AIPromptGenerator() {
  ...
  return (
    <Layout>
      <Head>
        <title>AI Prompt Generator - Create Perfect | ProURLMonitor</title>
        <meta name="description" content="Free AI Prompt Generator for ChatGPT, Claude, Gemini, and all AI tools. Generate optimized prompts for marketing, coding, writing, business, education,..." />
